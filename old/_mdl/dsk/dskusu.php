...
$aModule['js']['before']      = 'header.clearChild;body.clearChild;footer.clearChild;gl_Desktop.setURL("/ame/");gl_Desktop.getModule("dskbdy");gl_Desktop.getModule("sysnav");gl_Desktop.getModule("sysmnu");';   // limpando os containers
