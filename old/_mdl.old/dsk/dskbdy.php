...
$aModule['form']['form']      = 'dskbdy.html';   // Nome do arquivo HTML (False para não carregar nenhum formulario
$aModule['form']['container'] = 'body';               // Container do formulario
$aModule['js']['before'][]    = 'body.clearChild;gl_Desktop.setURL("/ame/");gl_Desktop.getModule("dskcld")';   // limpando os containers

$aIP = get_IP();
  $aModule['js']['after'][] = "ip.innerHTML ='{$aIP}' ";
