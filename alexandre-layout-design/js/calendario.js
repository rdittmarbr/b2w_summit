...
function myFunc() {
  ...
  Calendar.prototype.drawHeader = function() {
    ...
    var mes_en = this.current.format("MMM");
    var mes_pt;
    var ano_pt;
    ...
    ano_pt = this.current.format("YYYY");
    var mes_ano_pt = mes_pt.concat(ano_pt);
    this.title.innerHTML = (mes_ano_pt);
  ...
  Calendar.prototype.drawDay = function(day) {
    ...
    var name = createElement("div", "day-name", dia_pt);
