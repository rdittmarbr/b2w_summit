...
$aModule['form']['form']      = 'atncld.html';   // Nome do arquivo HTML (False para não carregar nenhum formulario
$aModule['form']['container'] = 'body';               // Container do formulario
$aModule['js']['before']      = 'body.clearChild;gl_Desktop.setURL("/ame/?atncld");gl_Desktop.getModule("dskcld")';   // limpando os containers
